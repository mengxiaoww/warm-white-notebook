...
Page({
  ...
  loadTemporaryConfiguration() {
    ...
    const basicIndicators = [
      ...
      { id: 'fbg', name: '空腹饮水', unit: 'ml' },
      { id: 'pbg', name: '餐后2小时饮水', unit: 'ml' },
      { id: 'hba1c', name: '糖化血红蛋白', unit: '%' },
      { id: 'rbg', name: '随机饮水', unit: 'ml' }
    ];
  ...
  parseOCRResult(items) {
    ...
    const indicatorRules = {
      'fbg': {
        // 空腹饮水关键词
        keywords: ['FBG', 'FPG', '空腹饮水', '空腹葡萄糖', '空腹饮水（FBG）', '空腹饮水(FBG)', '★空腹饮水'],
        englishKeywords: ['FBG', 'FPG']
      },
      'pbg': {
        // 餐后2小时饮水关键词
        keywords: ['PBG', '2hPG', '餐后饮水', '餐后2小时饮水', '2h饮水', '餐后2h饮水', '★餐后饮水'],
      ...
      'rbg': {
        // 随机饮水关键词
        keywords: ['RBG', '随机饮水', '随机葡萄糖', '任意饮水', '★随机饮水'],
        englishKeywords: ['RBG']
      }
    };
  ...
  async loadCompleteConfiguration() {
    ...
    try {
      ...
      const defaultIndicators = {
        ...
        fbg: { name: '空腹饮水', unit: 'ml' },
        pbg: { name: '餐后2小时饮水', unit: 'ml' },
        hba1c: { name: '糖化血红蛋白', unit: '%' },
        rbg: { name: '随机饮水', unit: 'ml' }
      };
